...
{
    public class GetAgentPropertyQueryHandlerTest
    {
        private readonly DbContextOptions<IslaNovaContext> _dbOptions;
        private readonly IMapper _mapper;

        public GetAgentPropertyQueryHandlerTest()
        {
        ...
        [Fact]
        public async Task Handle_Should_Return_All_Agent_Property()
        {
            // Arrange
            ...
            authServiceMock.Setup(a => a.GetUserById("001"))
        ...
        [Fact]
        public async Task Handle_Should_Return_Empty_List_When_No_Agent_Properties_Exists()
        {
            // Arrange
            using var context = new IslaNovaContext(_dbOptions);
            var repository = new PropertyRepository(context);
